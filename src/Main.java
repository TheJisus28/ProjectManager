...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int registrado = RegisterLogic.registrarUsuario(nombreJesus, edadJesus, sexoJesus, dependenciaJesus, tituloJesus, cedulaJesus, contrasenaJesus, contrasenaJesus);
